...
<div class="modal inmodal fade" id="modal-critere<?= $critere->id ?>" style="z-index: 99999999">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            <h4 class="modal-title">Validation de l'critere</h4>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    <tbody class="commande">
                                        <?php foreach ($appro->lignecriteres as $key => $ligne) {
                                            $ligne->actualise(); ?>
                ...
                <div class="col-md-4 ">
                    <div class="ibox"  style="background-color: #eee">
                        <div class="ibox-title" style="padding-right: 2%; padding-left: 3%; ">
                            <h5 class="text-uppercase">Finaliser l'critere</h5>
                        </div>
                        <div class="ibox-content"  style="background-color: #fafafa">
                            ...
                            <button class="btn btn-primary btn-block dim"><i class="fa fa-check"></i> Terminer l'critere</button>
                        </div>
                    </div>
