            ...
            <div class="col-lg-10">
                <div class="ibox"  >
                     ...
                     <div>
                      <div class="row">
                        ...
                        <div class="col-sm-7 text-right">
                            <h2 class="text-uppercase text-blue gras" style="font-size: 250%">Contrat de location</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="mp3 border text-center" style="padding-top: 3%">
                                ...
                                <h2 class="d-inline gras text-warning"><?= money($tarif->prixJournalier) ?> </h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 text-center">
                            <img style="width: 100%" src="<?= $this->stockage("images", "societe", "test.png") ?>">
                        </div>
                    </div><br><br>
