    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
          ...
          <div class="wrapper border-bottom white-bg ">
            <h4>This is main title</h4>
            <div class="row">
                <div class="col-sm-3">
                    <div class="ibox border">
                        <div class="" style="padding-left: 3px; height: 100px">
                            <i>Un véhicule du garage</i><br><br>
                ...
                <div class="col-sm-3">
                    <div class="ibox border">
                        <div class="" style="padding-left: 3px; height: 100px">
                            <i>Un nouveau véhicule</i><br>
                            <?php Native\BINDING::html("select", "marque") ?><br>
                ...
                <div class="col-sm-3">
                    <div class="ibox border">
                        <div class="" style="padding-left: 3px; height: 100px">
                            <i>Un dévis</i><br><br>
                            <?php Native\BINDING::html("select", "devis") ?>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
