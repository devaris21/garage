            ...
            <div class="row wrappe">
                <div class="tabs-container white-bg">
                    <ul class="nav nav-tabs text-uppercase" role="tablist">
                        <li><a class="nav-link active" data-toggle="tab" href="#menu-1"><i class="fa fa-information"></i> Véhicule</a></li>
                        <li><a class="nav-link" data-toggle="tab" href="#menu-2"><i class="fa fa-file-text-o"></i> Données techniques</a></li>
